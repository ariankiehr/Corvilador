...
public class DomainOfDiscurse {
    ...
    public static List<Character> letras = Arrays.asList( new Character[]{
    ...
    public static List<String> palabrasReservadas = Arrays.asList( new String[]{
	    "si","entonces","sino", "imprimir","entero","entero_ss","iterar","hasta","vector","de"
    });
    
    public static List<Character> todosCaracteresValidos = Arrays.asList( new Character[]{
	    LETRA,NUMERO,'_', '&', '(', ')', '{', '}', '[', ']', '-', '+', '*', '/', '>', '<',
	     '\'', ':', '=', '^', ';', ',', '\n', '\t', ' '
    });
